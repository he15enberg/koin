...
final List<BankInfo> bankInfoList = [
  ...
  // SBI sends transactional SMS under several other channel-specific codes
  // -- SBIINB alone matched under 2% of real SBI messages in live testing.
  BankInfo(
    code: 'SBIUPI',
    name: 'State Bank of India',
    image: 'assets/logos/State Bank of India.png',
    dominantColor: Color(0xFF1F4F99),
    lightColor: Color(0xFFB3C6E7),
  ),
  BankInfo(
    code: 'SBIBNK',
  ...
  // HDFC's second channel -- verified against live data to carry only
  // credit-card/loan marketing, never a real transaction. Still listed here
  // so a bank-info lookup never returns null for it (see SmsParserHelper's
  // nonTransactionalSenderCodes, which is what actually excludes it).
  BankInfo(
    code: 'HDFCBN',
    name: 'HDFC Bank',
    image: 'assets/logos/HDFC Bank.png',
    dominantColor: Color(0xFFED232A),
    lightColor: Color(0xFFF6B1B4),
  ),
  BankInfo(
    code: 'ICICIB',
